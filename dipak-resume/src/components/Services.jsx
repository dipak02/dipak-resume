  ...
  export default function Services(){
    ...
    return (
      <>
        ...
        <p className="text-3xl text-white font-bold mt-0">Services That I Provide</p> 
    </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
          {servicesData.map((data,index)=>
          
              <article key={index}
                className="rounded-lg  bg-[var(--primary-color)] hover:bg-gray-200 p-4 shadow-xs transition hover:shadow-lg sm:p-6"
              >
