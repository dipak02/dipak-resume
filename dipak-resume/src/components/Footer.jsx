      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        <div class="text-center sm:text-left">
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="#home">
                Home
              </a>
            </li>
        ...
        <div class="text-center sm:text-left">
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="#services">
                Web Development
              </a>
            </li>

            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="#services"> Graphics Design </a>
            </li>

            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="#services"> SEO Optimization </a>
            </li>
        ...
        <div class="text-center sm:text-left">
          ...
          <ul class="mt-8 space-y-4 text-sm">
            ...
            <li>
              <a class="text-gray-700 transition hover:text-gray-700/75" href="#support"> Support </a>
            </li>
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span class="flex-1 text-gray-700">shahdipak5654@gmail.com</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 text-gray-700">+977 9761653893</span>
              </a>
            </li>
